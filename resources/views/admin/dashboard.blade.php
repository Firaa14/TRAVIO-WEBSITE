...
<div class="row">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="stat-card text-center" style="border-left-color: var(--primary-color);">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h3 class="text-primary">{{ $bookingStats['car_bookings']['total'] }}</h3>
                    <p class="mb-0 text-muted">Total Booking Mobil</p>
                    <small class="text-success">{{ $bookingStats['car_bookings']['today'] }} hari ini</small>
                </div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="stat-card text-center" style="border-left-color: var(--success-color);">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h3 class="text-success">{{ $bookingStats['destination_bookings']['total'] }}</h3>
                    <p class="mb-0 text-muted">Total Booking Destination</p>
                    <small class="text-success">{{ $bookingStats['destination_bookings']['today'] }} hari ini</small>
                </div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="stat-card text-center" style="border-left-color: var(--warning-color);">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h3 class="text-warning">{{ $bookingStats['hotel_bookings']['total'] }}</h3>
                    <p class="mb-0 text-muted">Total Booking Hotel</p>
                    <small class="text-success">{{ $bookingStats['hotel_bookings']['today'] }} hari ini</small>
                </div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="stat-card text-center" style="border-left-color: var(--danger-color);">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h3 class="text-danger">{{ $bookingStats['package_bookings']['total'] }}</h3>
                    <p class="mb-0 text-muted">Total Booking Paket</p>
                    <small class="text-success">{{ $bookingStats['package_bookings']['today'] }} hari ini</small>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3 text-center mb-3">
                        <h4 class="text-warning">
                            {{ $bookingStats['car_bookings']['pending'] + 
                               $bookingStats['destination_bookings']['pending'] + 
                               $bookingStats['hotel_bookings']['pending'] + 
                               $bookingStats['package_bookings']['pending'] }}
                        </h4>
                        <p class="mb-0 text-muted">Pending</p>
                    </div>
                    <div class="col-md-3 text-center mb-3">
                        <h4 class="text-success">
                            {{ $bookingStats['car_bookings']['confirmed'] + 
                               $bookingStats['destination_bookings']['confirmed'] + 
                               $bookingStats['hotel_bookings']['confirmed'] + 
                               $bookingStats['package_bookings']['confirmed'] }}
                        </h4>
                        <p class="mb-0 text-muted">Dikonfirmasi</p>
                    </div>
                    <div class="col-md-3 text-center mb-3">
                        <h4 class="text-danger">
                            {{ $bookingStats['car_bookings']['cancelled'] + 
                               $bookingStats['destination_bookings']['cancelled'] + 
                               $bookingStats['hotel_bookings']['cancelled'] + 
                               $bookingStats['package_bookings']['cancelled'] }}
                        </h4>
...
<div class="row">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ Str::limit($booking->car->title ?? 'N/A', 20) }}</td>
                                    <td>
    ...
    <div class="col-lg-6 mb-4">
        <div class="card">
            ...
            <div class="card-body">
                @if($recentBookings['hotel']->count() > 0)
                    <div class="table-responsive">
                        <table class="table table-hover">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $booking->user->name ?? 'N/A' }}</td>
                                    <td>{{ Str::limit($booking->hotelDetail->name ?? 'N/A', 20) }}</td>
                                    <td>
                                        <span class="badge badge-{{ $booking->status == 'confirmed' ? 'success' : ($booking->status == 'cancelled' ? 'danger' : 'warning') }}">
                                            {{ ucfirst($booking->status) }}
                                        </span>
    ...
    <div class="col-lg-6 mb-4">
        <div class="card">
            ...
            <div class="card-body">
                @if($recentBookings['destination']->count() > 0)
                    <div class="table-responsive">
                        <table class="table table-hover">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $booking->user->name ?? 'N/A' }}</td>
                                    <td>{{ Str::limit($booking->destination->name ?? 'N/A', 20) }}</td>
                                    <td>
                                        <span class="badge badge-{{ $booking->status == 'confirmed' ? 'success' : ($booking->status == 'cancelled' ? 'danger' : 'warning') }}">
                                            {{ ucfirst($booking->status) }}
                                        </span>
    ...
    <div class="col-lg-6 mb-4">
        <div class="card">
            ...
            <div class="card-body">
                @if($recentBookings['package']->count() > 0)
                    <div class="table-responsive">
                        <table class="table table-hover">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $booking->user->name ?? 'N/A' }}</td>
                                    <td>{{ Str::limit($booking->package->name ?? 'N/A', 20) }}</td>
                                    <td>
                                        <span class="badge badge-{{ $booking->status == 'confirmed' ? 'success' : ($booking->status == 'cancelled' ? 'danger' : 'warning') }}">
                                            {{ ucfirst($booking->status) }}
                                        </span>
