...
@section('title', 'Booking Destinasi')
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Data Booking Destinasi</h3>
            ...
            <div class="card-body">
                ...
                @else
                    <div class="text-center py-4">
                        ...
                        <h5 class="text-muted">Belum ada booking destinasi</h5>
                        <p class="text-muted">Booking destinasi akan muncul di sini ketika ada customer yang melakukan pemesanan.</p>
                    </div>
                @endif
            </div>
        </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Detail Booking Destinasi</h5>
