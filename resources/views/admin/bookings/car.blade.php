    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Data Booking Mobil</h3>
            ...
            <div class="card-body">
                            ...
                            <tbody>
                                @foreach($bookings as $index => $booking)
                                    <tr>
                                        ...
                                        <td>{{ $booking->duration ?? 'N/A' }} hari</td>
                ...
                @else
                    <div class="text-center py-4">
                        ...
                        <h5 class="text-muted">Belum ada booking mobil</h5>
                        <p class="text-muted">Booking mobil akan muncul di sini ketika ada customer yang melakukan pemesanan.</p>
                    </div>
                @endif
            </div>
        </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Detail Booking Mobil</h5>
                    ...
                    <div class="col-md-6">
                        <table class="table table-borderless">
                            ...
                            <tr>
                                ...
                                <td>{{ $booking->end_date ? date('d M Y', strtotime($booking->end_date)) : 'N/A' }}</td>
                            </tr>
                            <tr>
                                <th>Durasi:</th>
                                <td>{{ $booking->duration ?? 'N/A' }} hari</td>
