...
@section('title', 'Booking Destination')
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Data Booking Destination</h3>
            ...
            <div class="card-body">
                            ...
                            <tbody>
                                @foreach($bookings as $index => $booking)
                                    <tr>
                                        ...
                                        <td>{{ $booking->destination->title ?? 'N/A' }}</td>
                                        <td>{{ $booking->travel_date ? date('d M Y', strtotime($booking->travel_date)) : 'N/A' }}</td>
                                        <td>{{ $booking->num_people ?? 'N/A' }} orang</td>
                ...
                @else
                    <div class="text-center py-4">
                        ...
                        <h5 class="text-muted">Belum ada booking destination</h5>
                        <p class="text-muted">Booking destination akan muncul di sini ketika ada customer yang melakukan pemesanan.</p>
                    </div>
                @endif
            </div>
        </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Detail Booking Destination</h5>
