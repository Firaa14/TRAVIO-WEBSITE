...
@section('title', 'Edit Detail Hotel')
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Form Edit Detail Hotel</h3>
            ...
            <form action="{{ route('admin.hotel-detail.update', $hotelDetail->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('hotel_id') is-invalid @enderror" 
                                    ...
                                    @foreach($hotels as $hotel)
                                        <option value="{{ $hotel->id }}" {{ old('hotel_id', $hotelDetail->hotel_id) == $hotel->id ? 'selected' : '' }}>
                                            {{ $hotel->title }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="nama" 
                                       name="nama" 
                                       value="{{ old('nama', $hotelDetail->nama) }}" 
                                       required>
                                @error('nama')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="location" 
                                       name="location" 
                                       value="{{ old('location', $hotelDetail->location) }}" 
                                       required>
                                @error('location')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="phone" 
                                       name="phone" 
                                       value="{{ old('phone', $hotelDetail->phone) }}">
                                @error('phone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" 
                                       ...
                                       id="email" 
                                       name="email" 
                                       value="{{ old('email', $hotelDetail->email) }}">
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       id="rating" 
                                       name="rating" 
                                       value="{{ old('rating', $hotelDetail->rating) }}" 
                                       min="0" 
                                       max="5" 
                                       step="0.1">
                                @error('rating')
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       id="price" 
                                       name="price" 
                                       value="{{ old('price', $hotelDetail->price) }}" 
                                       min="0">
                                @error('price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('address') is-invalid @enderror" 
                                  id="address" 
                                  name="address" 
                                  rows="2">{{ old('address', $hotelDetail->address) }}</textarea>
                        @error('address')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  id="description" 
                                  name="description" 
                                  rows="4">{{ old('description', $hotelDetail->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('facilities') is-invalid @enderror" 
                                  id="facilities" 
                                  name="facilities" 
                                  rows="3">{{ old('facilities', $hotelDetail->facilities) }}</textarea>
                        @error('facilities')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('syaratKetentuan') is-invalid @enderror" 
                                  ...
                                  rows="3">{{ old('syaratKetentuan', $hotelDetail->syaratKetentuan) }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" 
                               ...
                               id="map_url" 
                               name="map_url" 
                               value="{{ old('map_url', $hotelDetail->map_url) }}">
                        @error('map_url')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @if($hotelDetail->headerImage)
                                    <div class="mt-2">
                                        <p class="mb-1">Gambar header saat ini:</p>
