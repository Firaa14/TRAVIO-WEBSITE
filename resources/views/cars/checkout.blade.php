...
@section('content')
                ...
                <div class="bg-white rounded-xl shadow-lg p-8 border border-blue-100">
                    ...
                    <form action="{{ route('car.booking.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="mb-6">
                            ...
                            <div>
                                <label for="renter_name" class="block text-sm font-medium text-gray-700 mb-2">Full
                                    Name</label>
                                <input type="text"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                    id="renter_name" name="renter_name" required>
                        ...
                        <div id="driverFields" class="hidden mb-6">
                            ...
                            <div class="space-y-4">
                                <div>
                                    <label for="driver_name" class="block text-sm font-medium text-gray-700 mb-2">Driver
                                        Full Name</label>
                                    <input type="text"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                        id="driver_name" name="driver_name">
                                    <p class="text-sm text-gray-500 mt-1">Required for self-drive option</p>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="file"
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                            id="ktp" name="ktp" accept=".jpg,.png,.pdf">
                                        <p class="text-sm text-gray-500 mt-1">Upload your ID card (JPG, PNG, PDF)</p>
                                    </div>
                                    <div>
                                        <label for="sim_a" class="block text-sm font-medium text-gray-700 mb-2">SIM A
                                            (Driving License)</label>
                                        <input type="file"
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                            id="sim_a" name="sim_a" accept=".jpg,.png,.pdf">
                                        <p class="text-sm text-gray-500 mt-1">Upload your driving license (JPG, PNG, PDF)
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- Price Summary -->
                        <div class="bg-gradient-to-br from-gray-50 to-blue-50 p-6 rounded-xl border border-blue-200 mb-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex justify-between items-center" id="driverFeeRow" style="display: none;">
                        ...
                        <div class="text-center">
                            <button type="submit"
                                class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-4 px-8 rounded-lg transition duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
                                <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <script>
        ...
        function toggleDriverFields() {
            ...
            const simField = document.getElementById('sim_a');

            if (withDriverRadio.checked) {
                // With driver selected
                driverFields.classList.add('hidden');
                driverFeeRow.style.display = 'flex';
                // Remove required from self-drive fields
                driverNameField.required = false;
                ktpField.required = false;
                simField.required = false;
            } else {
                // Self drive selected
                driverFields.classList.remove('hidden');
                driverFeeRow.style.display = 'flex';
                // Add required to self-drive fields
                driverNameField.required = true;
                ktpField.required = true;
                simField.required = true;
            }
        ...
        function calculatePrice() {
            ...
            if (startDate && endDate) {
                ...
                if (days > 0) {
                    const subtotal = basePrice * days;
                    const driverFee = withDriverRadio && withDriverRadio.checked ? 100000 * days : 0;
                    const total = subtotal + driverFee;
