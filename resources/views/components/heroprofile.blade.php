...
<section class="hero-section">
    ...
    <video autoplay muted loop playsinline>
        <source src="{{ asset('videos/profile.mp4') }}" type="video/mp4">
    ...
    <div class="container d-flex flex-column justify-content-center align-items-center hero-content">
        <h1 class="fw-bold mb-3">Hai, User!</h1>
        <p>Manage your personal information, track bookings, and update your preferences – all in one place.</p>
    </div>
