<section class="position-relative text-white" style="height: 400px; overflow: hidden;">
    ...
    <div class="position-relative h-100 d-flex flex-column justify-content-center align-items-center"
        ...
        <div class="text-center">
            <h1 class="fw-bold mb-2" style="font-size:2.8rem;">Discover Your Perfect Getaway!</h1>
            <p class="lead mb-3" style="font-size:1.3rem;">Discover Malang’s top tourist destinations, where natural
                beauty, rich culture, and family adventures come together for an unforgettable travel experience.</p>
        </div>
    </div>
</section>
<style>
