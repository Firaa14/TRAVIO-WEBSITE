<section class="hero-section d-flex align-items-center justify-content-center"
    ...
    <div class="container text-center" style="position:relative; z-index:2;">
        <h1 class="fw-bold text-white mb-3" style="font-size:2.2rem; text-shadow: 2px 2px 8px rgba(0,0,0,0.7);">Welcome
            to
            Travio – Your Journey Starts Here!</h1>
        <p class="text-white mb-4" style="font-size:1.1rem; text-shadow: 1px 1px 6px rgba(0,0,0,0.6);">Experience Malang
            Raya like
            never before – from local flavors to the Arema spirit.</p>
