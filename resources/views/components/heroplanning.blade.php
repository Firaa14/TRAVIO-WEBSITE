...
<section class="hero-section">
    ...
    <div class="container d-flex flex-column justify-content-center align-items-center hero-content">
        <h1 class="fw-bold mb-3">Your Trip, Your Way!</h1>
        <p>Design your own adventure – choose destinations, activities, and duration. Create a personalized travel
            package that fits your style and schedule.</p>
    </div>

    <!-- Wave transition -->
    <div class="wave-transition">
        <svg viewBox="0 0 1920 100" preserveAspectRatio="none" style="width:100vw;height:100px;display:block;">
            <path d="M0,0 C480,100 1440,0 1920,100 L1920,100 L0,100 Z" fill="#f8f9fa" />
        </svg>
    </div>
</section>