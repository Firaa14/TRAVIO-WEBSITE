        ...
        <div id="invoiceToast" class="toast align-items-center text-bg-success border-0" role="alert" aria-live="assertive"
            ...
            <div class="d-flex">
                <div class="toast-body">
                    <strong>Pembayaran berhasil!</strong> Invoice hotel Anda sudah dibuat dan bisa diunduh.
                </div>
        ...
        <div class="card shadow-lg border-0 rounded-4 p-4 mx-auto animated-card invoice-bg"
            ...
            <div class="card-body position-relative">
                ...
                <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <div class="text-end">
                        <h5 class="fw-bold mb-0">INVOICE HOTEL</h5>
                ...
                <table class="table table-bordered mb-4 invoice-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{{ $booking['hotel']['check_in'] }}</td>
                            <td>{{ $booking['hotel']['check_out'] }}</td>
                            <td>{{ $booking['hotel']['room_type'] }}</td>
                            <td>Rp{{ number_format((float) $booking['hotel']['price_per_night'], 0, ',', '.') }}</td>
                            <td>{{ $booking['hotel']['nights'] }}</td>
                            <td><strong>Rp{{ number_format((float) $booking['hotel']['total_price'], 0, ',', '.') }}</strong>
                            </td>
                        </tr>
                    </tbody>
                </table>
